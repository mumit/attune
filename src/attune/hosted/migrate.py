...
FUNCTION_OWNER_TABLE_PRIVILEGES = frozenset(
    {
        ...
        ("attune_export_coordinator", "attune.jobs", "SELECT"),
        ("attune_export_coordinator", "attune.jobs", "UPDATE"),
        ("attune_export_coordinator", "attune.dispatch_intents", "SELECT"),
        ...
        ("attune_content_retention_executor", "attune.conversations", "SELECT"),
        ("attune_content_retention_executor", "attune.conversations", "DELETE"),
        ("attune_content_retention_executor", "attune.conversation_turns", "SELECT"),
        ("attune_content_retention_executor", "attune.conversation_turns", "DELETE"),
        (
            "attune_content_retention_executor",
            "attune.hosted_brief_deliveries",
            "SELECT",
        ...
        ("attune_content_retention_executor", "attune.audit_intents", "SELECT"),
        ("attune_content_retention_executor", "attune.audit_intents", "INSERT"),
        (
            "attune_deletion_request_executor",
            "attune.identity_sessions",
            "SELECT",
        ),
        ("attune_deletion_request_executor", "attune.principals", "SELECT"),
        ("attune_deletion_request_executor", "attune.tenants", "SELECT"),
        ("attune_deletion_request_executor", "attune.deletion_requests", "SELECT"),
        ("attune_deletion_request_executor", "attune.deletion_requests", "INSERT"),
        ("attune_deletion_request_executor", "attune.deletion_requests", "UPDATE"),
        ("attune_deletion_executor", "attune.deletion_requests", "SELECT"),
        ("attune_deletion_executor", "attune.deletion_requests", "UPDATE"),
        ("attune_deletion_executor", "attune.tenants", "SELECT"),
        ("attune_deletion_executor", "attune.tenants", "UPDATE"),
        ("attune_deletion_executor", "attune.principals", "SELECT"),
        ("attune_deletion_executor", "attune.principals", "UPDATE"),
        ("attune_deletion_executor", "attune.installations", "SELECT"),
        ("attune_deletion_executor", "attune.installations", "DELETE"),
        ("attune_deletion_executor", "attune.connectors", "SELECT"),
        ("attune_deletion_executor", "attune.connectors", "DELETE"),
        ("attune_deletion_executor", "attune.policies", "SELECT"),
        ("attune_deletion_executor", "attune.policies", "DELETE"),
        ("attune_deletion_executor", "attune.autonomy_grants", "SELECT"),
        ("attune_deletion_executor", "attune.autonomy_grants", "DELETE"),
        (
            "attune_deletion_executor",
            "attune.hosted_onboarding_states",
            "SELECT",
        ...
        ("attune_deletion_executor", "attune.memories", "SELECT"),
        ("attune_deletion_executor", "attune.memories", "DELETE"),
        ("attune_deletion_executor", "attune.memory_embeddings", "SELECT"),
        ("attune_deletion_executor", "attune.memory_embeddings", "DELETE"),
        ("attune_deletion_executor", "attune.conversations", "SELECT"),
        ("attune_deletion_executor", "attune.conversations", "DELETE"),
        ("attune_deletion_executor", "attune.conversation_turns", "SELECT"),
        ("attune_deletion_executor", "attune.conversation_turns", "DELETE"),
        ("attune_deletion_executor", "attune.importance_signals", "SELECT"),
        ("attune_deletion_executor", "attune.importance_signals", "DELETE"),
        ("attune_deletion_executor", "attune.attention_items", "SELECT"),
        ("attune_deletion_executor", "attune.attention_items", "DELETE"),
        (
            "attune_deletion_executor",
            "attune.hosted_brief_deliveries",
            "SELECT",
        ...
        ("attune_deletion_executor", "attune.connector_credentials", "SELECT"),
        ("attune_deletion_executor", "attune.connector_credentials", "DELETE"),
        (
            "attune_deletion_executor",
            "attune.hosted_channel_credentials",
            "SELECT",
        ...
        ("attune_deletion_executor", "attune.jobs", "SELECT"),
        ("attune_deletion_executor", "attune.jobs", "DELETE"),
        ("attune_deletion_executor", "attune.approvals", "SELECT"),
        ("attune_deletion_executor", "attune.approvals", "DELETE"),
        ("attune_deletion_executor", "attune.capability_admissions", "SELECT"),
        ("attune_deletion_executor", "attune.capability_admissions", "DELETE"),
        ("attune_deletion_executor", "attune.provider_events", "SELECT"),
        ("attune_deletion_executor", "attune.provider_events", "DELETE"),
        ("attune_deletion_executor", "attune.job_retries", "SELECT"),
        ("attune_deletion_executor", "attune.job_retries", "DELETE"),
        ("attune_deletion_executor", "attune.workflow_checkpoints", "SELECT"),
        ("attune_deletion_executor", "attune.workflow_checkpoints", "DELETE"),
        ("attune_deletion_executor", "attune.usage_records", "SELECT"),
        ("attune_deletion_executor", "attune.usage_records", "DELETE"),
        ("attune_deletion_executor", "attune.dispatch_intents", "SELECT"),
        ("attune_deletion_executor", "attune.dispatch_intents", "DELETE"),
        ("attune_deletion_executor", "attune.credential_intents", "SELECT"),
        ("attune_deletion_executor", "attune.credential_intents", "DELETE"),
        ("attune_deletion_executor", "attune.job_reconciliations", "SELECT"),
        ("attune_deletion_executor", "attune.job_reconciliations", "DELETE"),
        ("attune_deletion_executor", "attune.oauth_transactions", "SELECT"),
        ("attune_deletion_executor", "attune.oauth_transactions", "DELETE"),
        ("attune_deletion_executor", "attune.identity_sessions", "SELECT"),
        ("attune_deletion_executor", "attune.identity_sessions", "DELETE"),
        (
            "attune_deletion_executor",
            "attune.hosted_channel_setup_transactions",
            "SELECT",
        ...
        ("attune_deletion_executor", "attune.hosted_channel_routes", "SELECT"),
        ("attune_deletion_executor", "attune.hosted_channel_routes", "DELETE"),
        (
            "attune_deletion_executor",
            "attune.hosted_channel_deliveries",
            "SELECT",
        ...
        ("attune_deletion_executor", "attune.export_jobs", "SELECT"),
        ("attune_deletion_executor", "attune.export_jobs", "DELETE"),
        ("attune_deletion_executor", "attune.export_object_attempts", "SELECT"),
        ("attune_deletion_executor", "attune.export_object_attempts", "DELETE"),
        ("attune_deletion_executor", "attune.export_download_grants", "SELECT"),
