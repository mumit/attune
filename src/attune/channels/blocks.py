...
# can't drift apart.
ACTION_APPROVE = "attune_approve"
ACTION_EDIT = "attune_edit"
ACTION_REJECT = "attune_reject"
...
EDIT_MODAL_BLOCK_ID = "attune_edit_block"
EDIT_MODAL_INPUT_ID = "attune_edit_input"
...
def approval_blocks(
    *,
    ...
    blocks.append(
        {
            "type": "actions",
            "block_id": f"attune_approval:{thread_id}",
            "elements": [
                {
                    "type": "button",
