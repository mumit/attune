...
from aidedecamp.connectors.base import EmailThread, Provenance
from aidedecamp.orchestrator import (
    JsonNudgeState,
    find_nudge_candidates,
    run_follow_up_nudges,
)
from aidedecamp.orchestrator.followup import MAX_NUDGES_PER_RUN
...
def test_runtime_noop_without_real_email_or_state():
    from aidedecamp.runtime import Runtime

    runtime = Runtime(
        app=_app(), settings=Settings.from_env({"ADC_MEM0_URL": ""}),
